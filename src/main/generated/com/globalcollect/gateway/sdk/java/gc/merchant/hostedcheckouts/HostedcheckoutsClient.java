...
public interface HostedcheckoutsClient {
	 ...
	 * @throws GcApiException if the GlobalCollect platform returned any other error
	 */
	CreateHostedCheckoutResponse create(CreateHostedCheckoutRequest body, CallContext context);
	 ...
	 * @throws GcApiException if the GlobalCollect platform returned any other error
	 */
	GetHostedCheckoutResponse get(String hostedCheckoutId, CallContext context);
}
